        ...
        <main>
            ...
            <section id="quiz-section" class="hidden">
                ...
                <div id="quiz-results-screen" class="hidden text-center bg-[#e8ebe6] p-12 rounded-xl shadow-xl border-2 border-[#dbe0d7]">
                    ...
                    <button id="show-certificate-btn" class="bg-[#89b398] hover:bg-[#a1c4a4] text-white font-light py-4 px-10 rounded-full transition-all duration-300 transform hover:scale-105 shadow-md">証書を授かる</button>
                    <button id="restart-quiz-btn" class="bg-[#c3d1c4] hover:bg-[#dbe0d7] text-[#6a7c73] font-light py-4 px-10 rounded-full transition-all duration-300 transform hover:scale-105 mt-4">もう一度、練習へ</button>
                </div>
            </section>
        </main>
    </div>
    ...
    <div id="certificate-modal" class="modal-bg fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center p-4 z-50 hidden">
        <div id="certificate-content" class="modal-content bg-[#e8ebe6] rounded-xl shadow-2xl p-8 md:p-12 max-w-xl w-full text-center relative">
            ...
            <div class="certificate-border p-8">
                <h2 class="text-4xl font-light text-[#89b398] mb-2">文法証書</h2>
