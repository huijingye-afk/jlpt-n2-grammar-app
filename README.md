...
<body class="bg-[#f0f5f0] text-[#4d5c56] antialiased">
    ...
    <div id="app" class="container mx-auto p-6 md:p-12">
        <header class="text-center mb-16">
            <h1 class="text-5xl md:text-7xl font-light tracking-wide text-[#8a9990] leading-snug">艺珍の文法の森<span class="text-[#89b398] font-medium">の森</span></h1>
    ...
    <script>
        ...
        const grammarDataN5N4 = [
            ...
            { id: 21, grammar: '～ようにする', meaning: '努力做到...', examples: ['毎日運動する ようにします 。/我努力每天运动。'], parts: [['毎日', '運動する', 'ように', 'します']] },
            { id: 22, grammar: '～ようになる', meaning: '变得能够...', examples: ['毎日練習したので、自転車に 乗れるようになりました 。/因为每天练习，所以会骑自行车了。'], parts: [['毎日', '練習したので', '自転車に', '乗れるように', 'なりました']] },
            { id: 23, grammar: '～ているところだ', meaning: '正在进行...', examples: ['今、料理を 作っているところです 。/我现在正在做料理。'], parts: [['今', '料理を', '作っている', 'ところです']] },
            { id: 24, grammar: '～まま', meaning: '保持原样', examples: ['電気を つけたまま 寝てしまった。/开着灯就睡着了。'], parts: [['電気を', 'つけたまま', '寝て', 'しまった']] },
            { id: 25, grammar: '～せる／させる', meaning: '让...做...', examples: ['先生は生徒を 立たせました 。/老师让学生站着。'], parts: [['先生は', '生徒を', '立たせ', 'ました']] },
            { id: 26, grammar: '～（さ）せられる', meaning: '被迫做...', examples: ['私は先生に宿題を させられました 。/我被迫写了老师布置的作业。'], parts: [['私は', '先生に', '宿題を', 'させられ', 'ました']] },
            { id: 27, grammar: '～れる／られる（受身）', meaning: '被...', examples: ['彼は先生に 褒められました 。/他被老师表扬了。'], parts: [['彼は', '先生に', '褒められ', 'ました']] },
            { id: 28, grammar: '～れる／られる（可能）', meaning: '能够...', examples: ['私は日本語を 話せます 。/我能够说日语。'], parts: [['私は', '日本語を', '話せ', 'ます']] },
            { id: 29, grammar: '～から', meaning: '因为...', examples: ['疲れた から 、早く寝ます。/因为累了，早点睡。'], parts: [['疲れた', 'から', '早く', '寝ます']] },
            { id: 30, grammar: '～ので', meaning: '因为...ので比から在语义上更加客观', examples: ['雨が 降ったので 、出かけませんでした。/因为下雨了，所以没出门。'], parts: [['雨が', '降ったので', '出かけ', 'ませんでした']] },
            { id: 31, grammar: '～てください', meaning: '请...', examples: ['ドアを 開けてください 。/请打开门。'], parts: [['ドアを', '開けて', 'ください']] },
            { id: 32, grammar: '～なさい', meaning: '...吧（命令）', examples: ['早くご飯を 食べなさい 。/快点吃饭吧。'], parts: [['早く', 'ご飯を', '食べなさい']] },
            { id: 33, grammar: '～ましょう', meaning: '...吧（建议）', examples: ['一緒に帰り ましょう 。/一起回家吧。'], parts: [['一緒に', '帰りましょう']] },
            { id: 34, grammar: '～ませんか', meaning: '...吗？（邀请）', examples: ['お茶を 飲みませんか 。/要不要喝杯茶？'], parts: [['お茶を', '飲みませんか']] },
            { id: 35, grammar: '～をください', meaning: '请给我...', examples: ['このパン を下さい 。/请给我这个面包。'], parts: [['このパンを', '下さい']] },
            { id: 36, grammar: '～くらい／ぐらい', meaning: '大约...', examples: ['毎日2時間 ぐらい 日本語を勉強します。/每天学习日语大概2小时。'], parts: [['毎日', '2時間', 'ぐらい', '日本語を', '勉強します']] },
            { id: 37, grammar: '～ほど', meaning: '...的程度', examples: ['疲れて死ぬ ほど です。/累得快要死了。'], parts: [['疲れて', '死ぬ', 'ほどです']] },
            { id: 38, grammar: '～ほど～ない', meaning: '不像...那么...', examples: ['彼は私 ほど 背が高く ない 。/他没有我那么高。'], parts: [['彼は', '私ほど', '背が', '高くない']] },
            { id: 39, grammar: '～まで／までに', meaning: '直到...；在...之前', examples: ['9時 までに 学校に来てください。/请在9点之前来学校。'], parts: [['9時までに', '学校に', '来て', 'ください']] },
            { id: 40, grammar: '～がする', meaning: '感觉到...', examples: ['変な 音がします 。/有奇怪的声音。'], parts: [['変な', '音が', 'します']] },
            { id: 41, grammar: '～始める', meaning: '开始做...', examples: ['雨が 降り始めた 。/开始下雨了。'], parts: [['雨が', '降り', '始めた']] },
            { id: 42, grammar: '～出す', meaning: '突然开始...', examples: ['突然、彼が 笑い出した 。/他突然笑了起来。'], parts: [['突然', '彼が', '笑い出した']] },
            { id: 43, grammar: '～続ける', meaning: '持续做...', examples: ['彼は勉強を 続けました 。/他持续学习。'], parts: [['彼は', '勉強を', '続け', 'ました']] },
            { id: 44, grammar: '～過ぎる', meaning: '做得太...', examples: ['食べ 過ぎて お腹が痛い。/吃太多了肚子疼。'], parts: [['食べ', '過ぎて', 'お腹が', '痛い']] },
            { id: 45, grammar: '～てみる', meaning: '试着做...', examples: ['この服を 着てみても いいですか。/我可以试试穿这件衣服吗？'], parts: [['この服を', '着て', 'みても', 'いいですか']] },
            { id: 46, grammar: '～てしまう', meaning: '动作完成，遗憾；口语形式是～ちゃう/じゃう，口语中十分常用，前面也是动词て形，一定要记住喔！', examples: ['宿題を全部 やってしまいました 。/我把作业全部做完了。'], parts: [['宿題を', '全部', 'やって', 'しまいました']] },
            { id: 47, grammar: '～てばかり', meaning: '总是做某个动作；光是，净是', examples: ['彼は毎日遊ん でばかりいます 。/他每天净是玩。'], parts: [['彼は', '毎日', '遊んで', 'ばかりいます']] },
            { id: 48, grammar: '～たり～たりする', meaning: '又...又...；表示动作地列举，反复', examples: ['休みの日は、映画を 見たり 、本を 読んだり します。/休息日，我看看电影，读读书。'], parts: [['休みの日は', '映画を', '見たり', '本を', '読んだり', 'します']] },
            { id: 49, grammar: '～てあげる', meaning: '为别人做...；', examples: ['私は母に料理を 作ってあげました 。/我为妈妈做了料理。'], parts: [['私は', '母に', '料理を', '作って', 'あげました']] },
            { id: 50, grammar: '～てくれる', meaning: '别人为我做...；主语是别人！', examples: ['友達が私に本を 読んでくれました 。/朋友为我读了书。'], parts: [['友達が', '私に', '本を', '読んで', 'くれました']] },
            { id: 51, grammar: '～てもらう', meaning: '请别人为我做...主语是自己！（己方）', examples: ['先生に日本語を 教えてもらいました 。/我请老师教了日语。'], parts: [['先生に', '日本語を', '教えて', 'もらいました']] },
            { id: 52, grammar: '～つもりだ', meaning: '打算...', examples: ['明日、映画を見に 行くつもりです 。/我打算明天去看电影。'], parts: [['明日', '映画を', '見に', '行く', 'つもりです']] },
            { id: 53, grammar: '～はずだ', meaning: '应该...；主观上十分有依据的推测', examples: ['彼は日本語を勉強したので、 分かるはずだ 。/他学了日语，应该能懂。'], parts: [['彼は', '日本語を', '勉強したので', '分かる', 'はずだ']] },
            { id: 54, grammar: '～される（受身）', meaning: '被...', examples: ['彼は先生に 褒められました 。/他被老师表扬了。'], parts: [['彼は', '先生に', '褒められ', 'ました']] },
            { id: 55, grammar: '～れる（可能）', meaning: '能够...', examples: ['私は日本語を 話せます 。/我能够说日语。'], parts: [['私は', '日本語を', '話せ', 'ます']] },
            { id: 56, grammar: '～だけ', meaning: '只有...', examples: ['日本語が少し だけ 分かります。/我只懂一点点日语。'], parts: [['日本語が', '少しだけ', '分かります']] },
            { id: 57, grammar: '～と', meaning: '①和...；②一...就...》》条件假定！前面用动词原形！春になると、花が咲きます（一到春天花就会开）', examples: ['友達 と 映画を見に行きます。/和朋友一起去看电影。'], parts: [['友達と', '映画を', '見に', '行きます']] },
            { id: 58, grammar: '～ないで', meaning: '不...就...', examples: ['ごはんを 食べないで 寝ました。/没吃饭就睡了。'], parts: [['ごはんを', '食べないで', '寝ました']] },
            { id: 59, grammar: '～ながら', meaning: '一边...一边...;用动词ます的连用形', examples: ['音楽を 聞きながら 、勉強します。/我一边听音乐，一边学习。'], parts: [['音楽を', '聞きながら', '勉強します']] },
            { id: 60, grammar: '～について', meaning: '关于...', examples: ['日本の文化 について 、勉強します。/学习关于日本文化。'], parts: [['日本の', '文化について', '勉強します']] },
            { id: 61, grammar: '～にとって', meaning: '对...来说', examples: ['私 にとって 、家族が一番大切です。/对我来说，家人最重要。'], parts: [['私にとって', '家族が', '一番', '大切です']] },
            { id: 62, grammar: '～に対して', meaning: '对...；针对...', examples: ['お客様 に対して 、丁寧に対応します。/对客人，要礼貌地对待。'], parts: [['お客様に', '対して', '丁寧に対応', 'します']] },
            { id: 63, grammar: '～は～が', meaning: '大主题小主语；は前面的是主题，が前面是主语，在大的主题下对主语进行描述', examples: ['この本 は 値段 が 高いです。/这本书价格很贵。'], parts: [['この本は', '値段が', '高いです']] },
            { id: 64, grammar: '～くらい／ぐらい', meaning: '大约...；左右', examples: ['毎日2時間 くらい 日本語を勉強します。/我每天学习日语大概2小时。'], parts: [['毎日', '2時間くらい', '日本語を', '勉強します']] },
            { id: 65, grammar: '～ほど', meaning: '...的程度', examples: ['疲れて死ぬ ほど です。/累得快要死了。'], parts: [['疲れて', '死ぬほど', 'です']] },
            { id: 66, grammar: '～ほど～ない', meaning: '不像...那么...（没有那种程度。ほど作为【程度】的这个最基础的意思一定不能忘记）', examples: ['彼は私 ほど 背が高く ない 。/他没有我那么高。'], parts: [['彼は', '私ほど', '背が', '高くない']] },
            { id: 67, grammar: '～までに', meaning: '在...之前；到...为止', examples: ['9時 までに 学校に来てください。/请在9点之前来学校。'], parts: [['9時までに', '学校に', '来て', 'ください']] },
            { id: 68, grammar: '～ばいい', meaning: '...的话就好了；ば形是条件假定，记住这个意思文法就能自然理解！！', examples: ['もっと早く 起きればよかった 。/要是早点起床就好了。'], parts: [['もっと早く', '起きれば', 'よかった']] },
            { id: 69, grammar: '～ても', meaning: '即使...也...；ても在绝大多数情况下都具备转折的意思！', examples: ['雨が 降っても 行きます。/即使下雨也要去。'], parts: [['雨が', '降っても', '行きます']] },
            { id: 70, grammar: '～なければならない', meaning: '必须...；ば形是假定！！ない的假定なければ、加上なる的否定形式ならない、双重否定表示肯定！！！这种双重否定的文法有很多，虽然很长但是意思都是一样的！！', examples: ['明日、学校へ 行かなければなりません 。/明天必须去学校。'], parts: [['明日', '学校へ', '行かなければ', 'なりません']] },
            { id: 71, grammar: '～なくてはいけない', meaning: '不...不行；双重否定表示肯定！也可以翻译成：一定要；必须', examples: ['宿題を しなくてはいけません 。/必须做作业。'], parts: [['宿題を', 'しなくては', 'いけません']] },
            
            { id: 72, grammar: '～うちに', meaning: '在...期间；趁着', examples: ['暗くならない うちに 帰りましょう。/趁着天还没黑回家吧。'], parts: [['暗くならない', 'うちに', '帰りましょう']] },
            { id: 73, grammar: '～ところ', meaning: '正在...；前面是ている形式，表示正在；前面是动词原形，表示刚准备做（还没做），前面是动词た形，则表示刚做完。', examples: ['今、ご飯を 食べているところです 。/现在正在吃饭。'], parts: [['今', 'ご飯を', '食べている', 'ところです']] },
            { id: 74, grammar: '～ばかり', meaning: '净是...；光是...；名词＋ばかり', examples: ['彼は毎日ゲーム ばかり しています。/他每天净是玩游戏。'], parts: [['彼は', '毎日', 'ゲームばかり', 'しています']] },
            { id: 75, grammar: '〜ば', meaning: '如果...', examples: ['お金が あれば 、車を買います。/如果有钱，就买车。'], parts: [['お金が', 'あれば', '車を', '買います']] },
          
        
            { id: 76, grammar: '〜たらいい', meaning: '...的话就好了；跟～ばいい意思一样，都是假定形式加上いい', examples: ['もう少し 安かったらいいのに 。/要是再便宜一点就好了。'], parts: [['もう少し', '安かったら', 'いいのに']] }
        ];

        let selectedLevel = 'N5/N4';
        let currentGrammarData = grammarDataN5N4;
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function selectLevel(level) {
                ...
                levelBtns.forEach(btn => {
                    btn.classList.remove('bg-[#c3d1c4]', 'text-[#6a7c73]', 'shadow-md');
                    btn.classList.add('bg-white', 'text-[#a5b2ac]', 'hover:bg-[#c3d1c4]', 'hover:text-[#6a7c73]');
                    if (btn.dataset.level === level) {
                        btn.classList.add('bg-[#c3d1c4]', 'text-[#6a7c73]', 'shadow-md');
                        btn.classList.remove('bg-white', 'text-[#a5b2ac]');
                    }
                });

                if (level === 'N2') {
                    currentGrammarData = grammarDataN2;
                } else {
                    currentGrammarData = grammarDataN5N4;
                }
                renderGrammarCards();
            }
            ...
            function renderGrammarCards(filter = '') {
                ...
                const filteredData = currentGrammarData.filter(item => 
                    item.grammar.includes(filter) || 
                    item.meaning.includes(filter) || 
                    (item.nuance && item.nuance.includes(filter)) ||
                ...
                filteredData.forEach(item => {
                    ...
                    card.innerHTML = `
                        <div>
                            <h3 class="text-xl font-semibold text-[#4d5c56]">${item.id}. ${item.grammar}</h3>
                            <p class="text-[#4d5c56] mt-2">${item.meaning}</p>
                        </div>
                        <p class="text-sm text-[#a5b2ac] mt-4 self-start">${item.nuance ? item.nuance.split('/')[0] : ''}</p>
                    `;
            ...
            function showModal(item) {
                ...
                modalInnerContent.innerHTML = `
                    <div class="prose max-w-none text-[#4d5c56]">
                        ...
                        ${item.nuance ? `<p class="bg-[#f0f5f0] p-4 rounded-lg text-sm"><strong>ニュアンス：</strong> ${item.nuance.split('/')[0]} <br> <strong>中文解释：：</strong> ${item.nuance.split('/')[1]}</p>` : ''}
            ...
            function startQuiz() {
                const quizData = currentGrammarData.filter(item => item.parts && item.parts.length > 0 && item.examples && item.examples.length > 0);
